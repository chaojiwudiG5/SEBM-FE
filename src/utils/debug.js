...
// 调试路由信息
export function debugRouteInfo(to, from) {
...
// 调试权限检查
export function debugPermissionCheck(userRole, requiredRole) {
    ...
    console.log('用户角色名称:', roleNames[userRole]);
    console.log('所需角色名称:', roleNames[requiredRole]);
    console.groupEnd();
}
// 在开发环境下自动调试
