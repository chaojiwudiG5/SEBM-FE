...
export async function addMaintenanceTask(
    ...
    return request('/maintenance/mechanicanMaintenanceRecord/add', {
        method: 'POST',
        params: {
            ...params,
        },
...
export async function getRecordDetail(body, options) {
    return request('/maintenance/mechanicanMaintenanceRecord/getRecordDetail', {
        method: 'POST',
        headers: {
...
export async function listMyTasks(body, options) {
    return request('/maintenance/mechanicanMaintenanceRecord/myList', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function updateTaskStatus(body, options) {
    return request('/maintenance/mechanicanMaintenanceRecord/updateStatus', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
