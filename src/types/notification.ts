...
// 预定义的通知模板
export const NOTIFICATION_TEMPLATES: { [key: string]: NotificationTemplate } = {
    // 设备相关通知
    DEVICE_AVAILABLE: {
        id: 'device_available',
...
export class NotificationFactory {
    // 创建设备可用通知
    static createDeviceAvailableNotification(deviceName: string, deviceId: string) {
    ...
    // 创建设备维修通知
    static createDeviceMaintenanceNotification(deviceName: string, deviceId: string, issue: string) {
    ...
    // 创建借用申请通知
    static createBorrowRequestNotification(userName: string, deviceName: string, requestId: string) {
    ...
    // 创建借用批准通知
    static createBorrowApprovedNotification(deviceName: string, requestId: string) {
    ...
    // 创建借用拒绝通知
    static createBorrowRejectedNotification(deviceName: string, reason: string, requestId: string) {
    ...
    // 创建逾期提醒通知
    static createBorrowOverdueNotification(deviceName: string, daysOverdue: number, borrowId: string) {
    ...
    // 创建系统维护通知
    static createSystemMaintenanceNotification(startTime: string, duration: string) {
    ...
    // 创建安全警报通知
    static createSecurityAlertNotification(alertType: string, details: string) {
    ...
    // 创建通用通知
    static createGeneralNotification(title: string, content: string, priority: NotificationPriority = NotificationPriority.NORMAL) {
        return {
