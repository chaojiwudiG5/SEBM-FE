...
export async function addMaintenanceTask(
    ...
    return request<API.BaseResponseLong>(
        '/maintenance/mechanicanMaintenanceRecord/add',
        {
            method: 'POST',
            params: {
                ...params,
...
export async function getRecordDetail(
    ...
    return request<API.BaseResponseMechanicanMaintenanceRecordVo>(
        '/maintenance/mechanicanMaintenanceRecord/getRecordDetail',
        {
            method: 'POST',
            headers: {
...
export async function listMyTasks(
    ...
    return request<API.BaseResponsePageMechanicanMaintenanceRecordVo>(
        '/maintenance/mechanicanMaintenanceRecord/myList',
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
export async function updateTaskStatus(
    ...
    return request<API.BaseResponseBoolean>(
        '/maintenance/mechanicanMaintenanceRecord/updateStatus',
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
